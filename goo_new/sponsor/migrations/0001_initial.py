...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sponsor_sponsor', (
            ...
            ('payment_id', self.gf('django.db.models.fields.CharField')(default='DEVELOPER', max_length=32)),
        ))
        db.send_create_signal(u'sponsor', ['Sponsor'])

        # Adding model 'AuthKey'
        db.create_table(u'sponsor_authkey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('payment_id', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'sponsor', ['AuthKey'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sponsor_authkey')
