...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'files_file', ['path'])


        # Changing field 'File.path'
        db.alter_column(u'files_file', 'path', self.gf('django.db.models.fields.CharField')(max_length=350))
        # Adding unique constraint on 'File', fields ['path', 'filename']
        db.create_unique(u'files_file', ['path', 'filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'File', fields ['path', 'filename']
        db.delete_unique(u'files_file', ['path', 'filename'])


        # Changing field 'File.path'
        db.alter_column(u'files_file', 'path', self.gf('django.db.models.fields.TextField')(unique=True))
        # Adding unique constraint on 'File', fields ['path']
        db.create_unique(u'files_file', ['path'])
