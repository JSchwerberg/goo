...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'File.developer_id'
        db.delete_column(u'files_file', 'developer_id_id')

        # Adding field 'File.developer'
        db.add_column(u'files_file', 'developer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['developer.Developer'], null=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'File.developer_id'
        raise RuntimeError("Cannot reverse this migration. 'File.developer_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'File.developer_id'
        db.add_column(u'files_file', 'developer_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['developer.Developer']),
                      keep_default=False)

        # Deleting field 'File.developer'
        db.delete_column(u'files_file', 'developer_id')
    ...
    models = {
        ...
        u'files.file': {
            ...
            'developer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['developer.Developer']", 'null': 'True'}),
