...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'File.ro_rom'
        db.alter_column(u'files_file', 'ro_rom', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'File.ro_rom'
        db.alter_column(u'files_file', 'ro_rom', self.gf('django.db.models.fields.CharField')(max_length=65))
    ...
    models = {
        ...
        u'files.file': {
            ...
            'ro_board': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'ro_developerid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'ro_rom': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
