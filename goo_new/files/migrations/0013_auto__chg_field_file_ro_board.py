...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'File.ro_board'
        db.alter_column(u'files_file', 'ro_board', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'File.ro_board'
        db.alter_column(u'files_file', 'ro_board', self.gf('django.db.models.fields.CharField')(max_length=50))
